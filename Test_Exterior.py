...
def GetExteriorCounts():
    ...
    try:
        response = urllib2.urlopen('http://www.arb.ca.gov/aqmis2/display.php?download=y&param=PM25HR&units=001&year=2017&report=SITE1YR&statistic=DAVG&site=2143&ptype=aqd&monitor=-')
        data = response.read()
        response.close()
    except Exception as e:
    ...
    for line in lines:
        ...
        try:
            ...
            print "Problem with Exterior particle counts"    
            continue
    print Ext
    return (ExtTime, Ext)
